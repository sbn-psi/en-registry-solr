// $Id: ComparatorReport.java 5853 2010-02-06 22:54:00Z shardman $
//
...
public class CompareReport extends Report {
  ...
  protected void printHeader(PrintWriter writer) {
      ...
      writer.println();
    writer.println("Compare Details:");
  }
...
//    writer.print("  ");
    ...
    if (problem instanceof DiffException) {
        ...
        writer.print("      ");
        writer.print("Source: ");
        if (diffProblem.getSourceLineNumber() != null) {
            writer.print("line " + diffProblem.getSourceLineNumber() + " of ");
        }
        writer.println(diffProblem.getSourceURI().toString());
