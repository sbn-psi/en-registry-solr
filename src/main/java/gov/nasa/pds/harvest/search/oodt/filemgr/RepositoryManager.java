...
import gov.nasa.pds.harvest.search.oodt.filemgr.exceptions.RepositoryManagerException;
 ...
 *          {@link org.apache.oodt.cas.filemgr.structs.Product}s that are ingested into the File
 *          Manager. This includes information such as the root repository path for a product type,
 *          what type of URI generation scheme to apply, etc.
 *          </p>
 * 
 */
public interface RepositoryManager {
   ...
   * </p>
   * 
   * @param productType The {@link ProductType} to add.
   ...
   * </p>
   * 
   * @param productType The new {@link ProductType} information.
   ...
   * @throws RepositoryManagerException If any error occurs during the removal.
   */
   ...
   * </p>
   * 
   * @param productTypeId The ID of the ProductType to retrieve.
   * @return The {@link ProductType} corresponding to the specified <code>productTypeId</code>.
   * @throws RepositoryManagerException If any error occurs.
   */
  ...
  /**
   * <p>
   * Gets a {@link ProductType} specified by its <code>productTypeName</code>, from the
   * RepositoryManager.
   * </p>
   * 
   * @param productTypeName The name of the ProductType to get.
   * @return A {@link ProductType}, with the specified name.
   * @throws RepositoryManagerException If any error occurs.
   */
  ProductType getProductTypeByName(String productTypeName) throws RepositoryManagerException;
