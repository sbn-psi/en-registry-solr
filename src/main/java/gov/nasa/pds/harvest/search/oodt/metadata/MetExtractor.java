 ...
 * 
 *          <p>
 *          An interface for {@link Metadata} extraction. This interface expects the definition of
...
public interface MetExtractor {
   ...
   * 
   * @param f File object to extract Metadata from.
  ...
  /**
   * Sets the config file for this MetExtractor to the specified {@link File} <code>f</code>.
   * 
