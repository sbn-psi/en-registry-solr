...
public interface FilemgrMetExtractor {
   ...
   * 
   * @param product The given {@link Product}.
   * @param met The original {@link Metadata} provided during ingestion.
   * @return Extracted {@link Metadata} derived from the existing {@link Metadata} and
   *         {@link Product} provided.
   */
   ...
   * 
   * @param props The {@link Properties} object to configure this Metadata extractor with.
   */
