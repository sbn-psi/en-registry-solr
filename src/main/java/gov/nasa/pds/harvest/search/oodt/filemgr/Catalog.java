...
public interface Catalog extends Pagination {
   ...
   * </p>
   * 
   * @param m The {@link Metadata} to ingest.
   * @param product The product to add the metadata for.
   * @throws CatalogException If any general error occurs.
   */
   ...
   * </p>
   * 
   * @param m The {@link Metadata} to remove.
   * @param product The product for which the metadata is to be removed.
   * @throws CatalogException If any general error occurs.
   */
  void removeMetadata(Metadata m, Product product) throws CatalogException;
   ...
   * @throws CatalogException If any error occurs during the add.
   */
   ...
   * </p>
   * 
   * @param product The new {@link Product} information to modify the existing Product with.
  ...
  /**
   * <p>
   * Persists the <code>transferStatus</code> attribute of the given {@link Product} to the Catalog.
   * 
   ...
   * them with this {@link Product} specified by its <code>productId</code>.
   * </p>
   * 
   * @param product The product to add references for. The references are read from the Products
   *        list of References.
   * @throws CatalogException If anything goes wrong.
   */
   ...
   * @return A {@link Product}, with the given ID. The implementer of this method should ensure that
   *         the product {@link Reference}s are populated as well.
   * @throws CatalogException If any error occurs.
   */
   ...
   * @return A {@link Product} with the given name. The implementer of this method should ensure
   ...
   * </p>
   * 
   * @param product The {@link Product} to obtain the References for.
   * @return A {@link List} of {@link Reference}s, associated with the specified Product.
   * @throws CatalogException
   */
   ...
   * </p>
   * 
   * @param type The {@link ProductType} to obtain the {@link Product}s for.
   * @return A {@link List} of {@link Product}s that are associated with the specified productType
   *         in the {@link Catalog}.
   * @throws CatalogException If any error occurs.
   */
  List<Product> getProductsByProductType(ProductType type) throws CatalogException;
   ...
   * </p>
   * 
   * @param product The {@link Product} to obtain the Metadata for.
   ...
   * 
   * @param product The {@link Product} to obtain the Metadata for.
   * @param elements The set of metadata elements of interest.
   * @return The reduced {@link Metadata} for the given <code>productId</code>.
   * @throws CatalogException If any error occurs.
   */
  Metadata getReducedMetadata(Product product, List<String> elements) throws CatalogException;
   ...
   * .
   * 
   * @param query The set of criteria by which to query the Catalog.
   * @param type The {@link ProductType} that should be queried.
   * @return A {@link List} of String product IDs that can be used to retrieve products that match
   *         the query.
   * @throws CatalogException If any error occurs.
   */
  ...
  /**
   * <p>
   * Performs a query against the underlying {@link Catalog}, and then properly formulates a page of
   * results to send back to the user. This method is useful when you would like to conserve memory
   * and not send back the entire list of results, nor load them into memory. Of course, this method
   * assumes that queries are deterministic, i.e., the same query issued 2x within a paginating
   * session will produce the same set of results to paginate.
   * </p>
   * 
   * @param query The query to perform against the underlying Catalog.
   * @param type The {@link ProductType} that you are querying for.
   * @param pageNum The number of the {@link ProductPage} to return back to the user.
   * @return The requested {@link ProductPage} of results.
   * @throws CatalogException If any error occurs.
   */
  ProductPage pagedQuery(Query query, ProductType type, int pageNum) throws CatalogException;

  /**
   * <p>
   * Gets the top <code>N</code> most recent products that have been cataloged.
   * </p>
   * 
   * @param n The amount of recent products to return.
   * @return A {@link List} of {@link Product}s that have been cataloged recently.
   * @throws CatalogException If any error occurs.
   */
  ...
  /**
   * <p>
   * Gets the top <code>N</code> most recent products that have been cataloged for the given
   * {@link ProductType}.
   * </p>
   * 
   * @param n The amount of recent products to return.
   * @param type The ProductType to limit the query to.
   * @return A {@link List} of {@link Product}s that have been cataloged recently.
   * @throws CatalogException If any error occurs.
   */
  List<Product> getTopNProducts(int n, ProductType type) throws CatalogException;

  /**
   * 
   * @return The {@link ValidationLayer} that is used by this Catalog.
   * @throws CatalogException If any error occurs (e.g., the layer isn't initialized).
   */
  ValidationLayer getValidationLayer();

  /**
   * 
   * @param type The ProductType to count the number of products for.
   * @return An integer count of the number of {@link Product}s for the specified
   *         {@link ProductType}.
   * @throws CatalogException If any error occurs.
   */
