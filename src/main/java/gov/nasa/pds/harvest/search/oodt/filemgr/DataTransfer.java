...
public interface DataTransfer {
  ...
  /**
   * 
   * @param url The URL to the File Manager that this transferer will be transferring Products to.
   */
  void setFileManagerUrl(URL url);

  /**
   * 
   * @param product The product that is being transferred. The product should have both its
   *        origFileLocation, as well as its dataStoreRefs filled in to perform the transfer.
   * @throws DataTransferException If a general error occurs during the transfer.
   * @throws IOException If there is an IO eerror when performing the transfer.
   */
   ...
   * @throws IOException If there is an IO eerror when performing the transfer.
   */
  void retrieveProduct(Product product, File directory) throws DataTransferException, IOException;
