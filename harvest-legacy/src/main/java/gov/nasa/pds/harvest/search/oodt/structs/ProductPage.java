...
public class ProductPage {
   ...
   * @param totalPages The total number of pages in the set.
   * @param pageSize The size of this page.
   * @param pageProducts The products associated with this page.
   */
  public ProductPage(int pageNum, int totalPages, int pageSize, List<Product> pageProducts) {
  ...
  /**
   * @param pageProducts The pageProducts to set.
   */
