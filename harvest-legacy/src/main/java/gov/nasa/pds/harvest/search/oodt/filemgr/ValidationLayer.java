...
import gov.nasa.pds.harvest.search.oodt.filemgr.exceptions.ValidationLayerException;
 ...
 * 
 *          <p>
 *          The Validation Layer for the File Manager, allowing {@link Element}s to be mapped to
 *          {@link ProductType}s.
 *          </p>
 * 
 */
public interface ValidationLayer {
   ...
   * @throws ValidationLayerException If any error occurs during the add.
   */
   ...
   * </p>
   * 
   * @param element The new {@link Element} data to update.
  ...
  /**
   * <p>
   * Adds the specified <code>element</code> to the {@link ProductType} specified by its
  ...
  /**
   * <p>
   * Removes a metadata {@link Element} from the specified <code>productTypeId</code>.
   * </p>
   * 
   * @param type The {@link ProductType} to remove the association of the specified
   *        <code>element</code> with.
   ...
   * @throws ValidationLayerException If any error occurs.
   */
  List<Element> getElements(ProductType type) throws ValidationLayerException;

  /**
   * @return A {@link List} of all the metadata {@link Element}s in the ValidationLayer.
   * @throws ValidationLayerException If any error occurs.
   */
   ...
   * 
   * @param elementId The String identifier of the {@link Element} to get.
   * @return An {@link Element} by its String identifier.
   * @throws ValidationLayerException If any error occurs.
   */
  Element getElementById(String elementId) throws ValidationLayerException;

  /**
   * Gets an element by its String name.
   * 
   * @param elementName The String name of the {@link Element} to get.
   * @return An {@link Element} by its String name.
   * @throws ValidationLayerException If any error occurs.
   */
  Element getElementByName(String elementName) throws ValidationLayerException;
