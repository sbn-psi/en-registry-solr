 ...
 * 
 *          <p>
 *          An interface for pagination of {@link org.apache.oodt.cas.filemgr.structs.Product}
...
public interface Pagination {
  ...
  /**
   * @param type The ProductType to obtain the first {@link ProductPage} for.
  ...
  /**
   * 
   * @param type The ProductType to obtain the last {@link ProductPage} for.
  ...
  /**
   * 
   * @param type The ProductType to obtain the next page for, given the <code>currentPage</code>.
