...
public abstract class TypeHandler {
  ...
  /**
   * Handles converting any Catalog metadata element values to their original values. Metadata
   * elements can be added, modified, or replaced.
   * 
  ...
  /**
   * Handles converting any metadata element to Catalog element values. Metadata elements can be
   * added, modified, or replaced.
   * 
  ...
  /**
   * Converts the given RangeQueryCriteria into a QueryCriteria with the necessary Catalog elements
   * and values to perform the query
   * 
   * 
   * @param qc
   * @return
  ...
  /**
   * Converts the given TermQueryCriteria into a QueryCriteria with the necessary Catalog elements
   * and values to perform the query
   * 
   * @param qc
   * @return
