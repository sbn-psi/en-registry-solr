...
public class DOMUtil {
   ...
   * </p>
   * 
   * @param element The DOM Element node to traverse.
   * @param name The XML name of the Element to return.
   ...
   * <Tag><Tag2>here is text</Tag2></Tag>)
   * </p>
   * *
   * 
   * @param node The DOM 'SimpleElement' as defined in the Function definition.
   * @param name The name of the Text to retreive.
   ...
   * </p>
   * 
   * @param node The DOM XML Tag, with text inbetween.
