...
public final class EnvUtilities {
  ...
  /**
   * This method returns a particular named environment variable from the user's working environment
   * using the {@link #getEnv()} method to grab that environment.
   * 
  ...
  /**
   * This method does exactly the same thing as {@link #getEnvUsingWaitFor()}, except it uses
   * System.getenv()
   * 
  ...
  /**
   * This method grabs the current environment using the Linux shell program called
   * <code>env</code>. Unfortunately, this method also uses {@link Process#waitFor()}, which seems
  ...
  /**
   * This method turns an {@link InputStream} into a String. Method taken from:<br>
   * 
   * <a href=
   * "http://snippets.dzone.com/posts/show/555">http://snippets.dzone.com/posts/show/555</a>.
   * 
