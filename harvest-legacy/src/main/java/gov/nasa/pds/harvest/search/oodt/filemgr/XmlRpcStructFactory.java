...
import gov.nasa.pds.harvest.search.oodt.structs.Element;
import gov.nasa.pds.harvest.search.oodt.structs.ExtractorSpec;
import gov.nasa.pds.harvest.search.oodt.structs.FileTransferStatus;
...
import gov.nasa.pds.harvest.search.oodt.structs.Reference;
import gov.nasa.pds.harvest.search.oodt.structs.TermQueryCriteria;
import gov.nasa.pds.harvest.search.oodt.structs.query.ComplexQuery;
import gov.nasa.pds.harvest.search.oodt.structs.query.FilterAlgor;
import gov.nasa.pds.harvest.search.oodt.structs.query.QueryFilter;
import gov.nasa.pds.harvest.search.oodt.structs.type.TypeHandler;
...
public final class XmlRpcStructFactory {
  ...
  public static Map<String, Object> getXmlRpcFileTransferStatus(FileTransferStatus status) {
  ...
  public static FileTransferStatus getFileTransferStatusFromXmlRpc(Map<String, Object> statusHash) {
    ...
    status.setParentProduct(
        getProductFromXmlRpc((Hashtable<String, Object>) statusHash.get("parentProduct")));
    status
        .setFileRef(getReferenceFromXmlRpc((Hashtable<String, Object>) statusHash.get("fileRef")));
    return status;
  }

  public static Vector<Map<String, Object>> getXmlRpcFileTransferStatuses(
      List<FileTransferStatus> statuses) {
  ...
  public static List<FileTransferStatus> getFileTransferStatusesFromXmlRpc(
  ...
  public static Map<String, Object> getXmlRpcProductPage(ProductPage page) {
    ...
    productPageHash.put("pageProducts", getXmlRpcProductList(page.getPageProducts()));
  ...
  public static ProductPage getProductPageFromXmlRpc(Map<String, Object> productPageHash) {
    ...
    page.setPageSize((Integer) productPageHash.get("pageSize"));
    page.setTotalPages((Integer) productPageHash.get("totalPages"));
    page.setPageProducts(getProductListFromXmlRpc(
        (Vector<Map<String, Object>>) productPageHash.get("pageProducts")));
    return page;
  }
  ...
  public static Map<String, Object> getXmlRpcComplexQuery(ComplexQuery complexQuery) {
    ...
    if (complexQuery.getReducedProductTypeNames() != null) {
      complexQueryHash.put("reducedProductTypeNames",
          new Vector<String>(complexQuery.getReducedProductTypeNames()));
    } else {
      complexQueryHash.put("reducedProductTypeNames", new Vector<String>());
    }
    if (complexQuery.getReducedMetadata() != null) {
      complexQueryHash.put("reducedMetadata",
          new Vector<String>(complexQuery.getReducedMetadata()));
    } else {
  ...
  public static ComplexQuery getComplexQueryFromXmlRpc(Map<String, Object> complexQueryHash) {
    ...
    if (((Vector<String>) complexQueryHash.get("reducedProductTypeNames")).size() > 0) {
      complexQuery.setReducedProductTypeNames(
          (Vector<String>) complexQueryHash.get("reducedProductTypeNames"));
    }
  ...
  public static Map<String, Object> getXmlRpcQueryFilter(QueryFilter queryFilter) {
    ...
    queryFilterHash.put("versionConverterClass",
        queryFilter.getConverter().getClass().getCanonicalName());
  ...
  public static QueryFilter getQueryFilterFromXmlRpc(Map<String, Object> queryFilterHash) {
    ...
    FilterAlgor filterAlgor =
        getFilterAlgorFromXmlRpc((Map<String, Object>) queryFilterHash.get("filterAlgor"));
    QueryFilter queryFilter =
        new QueryFilter(startDateTimeMetKey, endDateTimeMetKey, priorityMetKey, filterAlgor);
  ...
  public static FilterAlgor getFilterAlgorFromXmlRpc(Map<String, Object> filterAlgorHash) {
    FilterAlgor filterAlgor = GenericFileManagerObjectFactory
        .getFilterAlgorFromClassName((String) filterAlgorHash.get("class"));
    if (filterAlgor != null) {
  ...
  public static List<QueryResult> getQueryResultsFromXmlRpc(
  ...
  public static Map<String, Object> getXmlRpcProduct(Product product) {
    ...
    if (product.getProductReferences() != null) {
      productHash.put("references", getXmlRpcReferences(product.getProductReferences()));
    }
    if (product.getRootRef() != null) {
      productHash.put("rootReference", getXmlRpcReference(product.getRootRef()));
    }
    return productHash;
  }
  ...
  public static Product getProductFromXmlRpc(Map<?, ?> productHash) {
    ...
    if (productHash.get("type") != null) {
      product
          .setProductType(getProductTypeFromXmlRpc((Map<String, Object>) productHash.get("type")));
    }
    ...
    if (productHash.get("references") != null) {
      product.setProductReferences(
          getReferencesFromXmlRpc((Vector<Map<String, Object>>) productHash.get("references")));
    }
    if (productHash.get("rootReference") != null) {
      product.setRootRef(
          getReferenceFromXmlRpc((Map<String, Object>) productHash.get("rootReference")));
    }
    return product;
  }
  ...
  public static Vector<Map<String, Object>> getXmlRpcProductTypeList(
  ...
  public static List<ProductType> getProductTypeListFromXmlRpc(
  ...
  public static ProductType getProductTypeFromXmlRpc(Map<String, Object> productTypeHash) {
    ...
    if (productTypeHash.get("typeExtractors") != null) {
      type.setExtractors(getTypeExtractorsFromXmlRpc(
          (Vector<Map<String, Object>>) productTypeHash.get("typeExtractors")));
    }
    if (productTypeHash.get("typeHandlers") != null) {
      type.setHandlers(getTypeHandlersFromXmlRpc(
          (Vector<Map<String, Object>>) productTypeHash.get("typeHandlers")));
    }
    return type;
  }

  public static Vector<Map<String, Object>> getXmlRpcTypeExtractors(
  ...
  public static Map<String, Object> getXmlRpcExtractorSpec(ExtractorSpec spec) {
    ...
    extractorHash.put("config", getXmlRpcProperties(spec.getConfiguration()));
  ...
  public static Map<String, Object> getXmlRpcTypeHandler(TypeHandler typeHandler) {
    ...
    handlerHash.put("className",
        typeHandler != null ? typeHandler.getClass().getCanonicalName() : "");
    handlerHash.put("elementName", typeHandler != null ? typeHandler.getElementName() : "");
    return handlerHash;
  }

  public static List<ExtractorSpec> getTypeExtractorsFromXmlRpc(
      Vector<Map<String, Object>> extractorsVector) {
  ...
  @SuppressWarnings("unchecked")
  public static ExtractorSpec getExtractorSpecFromXmlRpc(Map<String, Object> extractorSpecHash) {
    ExtractorSpec spec = new ExtractorSpec();
    spec.setClassName((String) extractorSpecHash.get("className"));
    spec.setConfiguration(
        getPropertiesFromXmlRpc((Map<String, String>) extractorSpecHash.get("config")));
    return spec;
  }

  public static List<TypeHandler> getTypeHandlersFromXmlRpc(
      Vector<Map<String, Object>> handlersVector) {
  ...
  public static TypeHandler getTypeHandlerFromXmlRpc(Map<String, Object> typeHandlerHash) {
  ...
  public static List<Reference> getReferencesFromXmlRpc(
      Vector<Map<String, Object>> referenceVector) {
  ...
  public static Map<String, Object> getXmlRpcReference(Reference reference) {
    ...
    referenceHash.put("dataStoreReference",
        reference.getDataStoreReference() != null ? reference.getDataStoreReference() : "");
    referenceHash.put("fileSize", Long.toString(reference.getFileSize()));
    referenceHash.put("mimeType",
        (reference.getMimeType() == null) ? "" : reference.getMimeType().getName());
    return referenceHash;
  }

  public static Reference getReferenceFromXmlRpc(Map<String, Object> referenceHash) {
    Reference reference = new Reference();
    reference.setDataStoreReference((String) referenceHash.get("dataStoreReference"));
  ...
  public static Vector<Map<String, Object>> getXmlRpcElementListHashtable(
  ...
  public static Map<String, Object> getXmlRpcElement(Element element) {
    ...
    elementHash.put("dcElement", element.getDCElement() != null ? element.getDCElement() : "");
  ...
  public static Query getQueryFromXmlRpc(Map<String, Object> queryHash) {
    ...
    List<QueryCriteria> criteria =
        getQueryCriteriaListFromXmlRpc((Vector<Map<String, Object>>) queryHash.get("criteria"));
    query.setCriteria(criteria);
    return query;
  }

  public static Vector<Map<String, Object>> getXmlRpcQueryCriteriaList(
      List<QueryCriteria> criteriaList) {
    Vector<Map<String, Object>> criteriaVector =
        new Vector<Map<String, Object>>(criteriaList.size());
  ...
  public static List<QueryCriteria> getQueryCriteriaListFromXmlRpc(
      Vector<Map<String, Object>> criteriaVector) {
  ...
  public static Map<String, Object> getXmlRpcQueryCriteria(QueryCriteria criteria) {
    ...
    if (criteria instanceof TermQueryCriteria) {
      ...
      criteriaHash.put("elementName", criteria.getElementName());
      criteriaHash.put("elementStartValue",
          ((RangeQueryCriteria) criteria).getStartValue() != null
              ? ((RangeQueryCriteria) criteria).getStartValue()
              : "");
      criteriaHash.put("elementEndValue",
          ((RangeQueryCriteria) criteria).getEndValue() != null
              ? ((RangeQueryCriteria) criteria).getEndValue()
              : "");
      criteriaHash.put("inclusive",
          Boolean.toString(((RangeQueryCriteria) criteria).getInclusive()));
  ...
  public static QueryCriteria getQueryCriteriaFromXmlRpc(Map<String, Object> criteriaHash) {
    ...
    if (criteriaHash.get("class").equals(TermQueryCriteria.class.getCanonicalName())) {
      ...
      criteria.setElementName((String) criteriaHash.get("elementName"));
      String startVal = criteriaHash.get("elementStartValue").equals("") ? null
          : (String) criteriaHash.get("elementStartValue");
      String endVal = criteriaHash.get("elementEndValue").equals("") ? null
          : (String) criteriaHash.get("elementEndValue");
      ((RangeQueryCriteria) criteria).setStartValue(startVal);
      ((RangeQueryCriteria) criteria).setEndValue(endVal);
      ((RangeQueryCriteria) criteria)
          .setInclusive(Boolean.parseBoolean((String) criteriaHash.get("inclusive")));
