...
// chunkSize =
// Integer.getInteger("org.apache.oodt.cas.filemgr.datatransfer.remote.chunkSize", 1024);
//
// LOG.log(Level.INFO, "RemoteDataTransfer enabled: using chunk size: [" + chunkSize + "]");
// }
//
// /*
// * (non-Javadoc)
